...
public interface MyStringInterface {
     ...
     *   in the following alphabet: "a"=0, "b"=1, …, "z"=25, "A"=26, …, "Z"=51, "0"=52, …, "9"=61.
     ...
     *   (again, where "a"=0, "b"=1, …, "z"=25, "A"=26, …, "Z"=51, "0"=52, …, "9"=61).
     ...
     * - Explanation:
     *   "C" has a value of 28, (28*5 + 3) % 62 = 19, 19 -> "t".
     *   "a" has a value of 0, (0*5 + 3) % 62 = 3, 3 -> "d".
     *   "t" has a value of 19, (19*5 + 3) % 62 = 36, 36 -> "K".
     *   " " remains unchanged.
     *   "&" remains unchanged.
     *   " " remains unchanged.
     *   "5" has a value of 57,  (57*5 + 3) % 62 = 40, 40 -> "O".
     *   ...
