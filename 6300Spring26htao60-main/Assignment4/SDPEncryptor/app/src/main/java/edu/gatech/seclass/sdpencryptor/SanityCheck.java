...
public class SanityCheck {
    ...
    int test1 = R.id.plainTextInputID;
    int test2 = R.id.key1InputID;
    int test3 = R.id.key2InputID;
    int test4 = R.id.generateCipherTextButtonID;
    int test5 = R.id.cipherTextOutputID;
